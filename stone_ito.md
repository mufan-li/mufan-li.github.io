...
we define the **cross variation** as 
...
$$ \mathbb{E} \left( \int_0^t H_s dM_s
    \right) 
...
a Banach algebra which contains a non-zero constant function. 
...
Next we show that $$\mathcal{A}$$ forms a Banach algebra. 
...
the cross variation with one finite variation process is zero,
